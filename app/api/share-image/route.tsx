    ...
    (
      ...
      >
        ...
        >
          ...
          <div style={{ marginTop: 70, display: "flex", flexDirection: "column", gap: 10 }}>
            <div style={{ fontSize: 24, color: "#9a765d", fontWeight: 800 }}>古诗文表达</div>
            {quoteLines.map((line) => (
              <div key={line} style={{ fontSize: 64, lineHeight: 1.18, fontWeight: 900, letterSpacing: 2 }}>{line}</div>
            ))}
          </div>

          <div style={{ marginTop: 38, fontSize: 32, color: "#6c4b35", fontWeight: 800 }}>出处：{dynasty}·{author}《{title}》</div>
