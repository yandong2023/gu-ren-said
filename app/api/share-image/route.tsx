...
export async function GET(request: Request) {
  ...
  const reason = readParam(url, "reason", "这句古诗文和你的现代话意思相近，且有真实出处可查。");
    ...
    (
      ...
      >
        ...
        >
          ...
          <div style={{ marginTop: 42, display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <div style={{ marginTop: 30, fontSize: 30, color: "#6c4b35", fontWeight: 800 }}>出处：{dynasty}·{author}《{title}》</div>

          <div style={{ flex: 1 }} />

          <div style={{ display: "flex", flexDirection: "column", gap: 10, padding: 24, borderRadius: 26, background: "rgba(182,93,66,0.08)", color: "#7b614d" }}>
            <div style={{ fontSize: 24, fontWeight: 900, color: "#8b6042" }}>为什么适合</div>
            <div style={{ fontSize: 28, lineHeight: 1.45 }}>{reason}</div>
          </div>

          <div style={{ marginTop: 28, display: "flex", alignItems: "center", justifyContent: "space-between", color: "#9b897a", fontSize: 22, letterSpacing: 2 }}>
