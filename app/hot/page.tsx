  ...
  return (
    <main className="shell">
      ...
      <section className="section-title hot-title">
        <div>
          <h1>热门反查</h1>
          <p>看看最近大家最想查成古诗文表达的现代话、网络梗和日常表达。</p>
        </div>
      </section>

      <section className="hot-ranking" aria-label="热门反查榜">
      ...
      <section aria-label="热门知识卡片预览">
        <div className="section-title"><div><h2>热门知识卡片</h2><p>点开任意一句，查看对应的古诗文原句和出处。</p></div></div>
